...
****************************************************************************
PROJECT : GRAPE
FILE    : $Id: fw_clibal_ansi.c 11006 2016-11-07 16:32:44Z michael.golczewski $
...
/*******************************************************************************
  Title: CLIBAL dummy module
  
  This module manages the CLIBAL functions.
*/
...
int32_t FW_CLIBAL_PrintF(const int8_t *String, ...) 
{
    ...
    x = vprintf((const char*)String, parameter);
    va_end(parameter);
    return x;
}
...
int32_t FW_CLIBAL_SPrintF(int8_t *Str, const int8_t *String, ...) 
{
    ...
    va_start(parameter, String);
    x = vsprintf((char*)Str, (char*)String, parameter);
    va_end(parameter);
    return x;
}
...
/*******************************************************************************
  Function: FW_CLIBAL_Malloc
  
  See: clibal.h for details
*/

void *FW_CLIBAL_Malloc(uint32_t Size ) 
{
    void *ret;
...
/*******************************************************************************
  Function: FW_CLIBAL_free
  
  See: clibal.h for details
*/

void FW_CLIBAL_Free(void *Ptr) 
{
    free(Ptr);
}
