...
FILE    : $Id: r_ssif_main.h 3935 2014-09-23 08:52:32Z golczewskim $
============================================================================ 
DESCRIPTION
Generic SSIF driver
============================================================================
...
typedef struct {
    ...
    uint32_t   Settings;
    uint32_t   Config;
    void       (*IsrCallback[R_SSIF_INT_NUM])(void);
...
DEF_EXTERN_ r_ssif_Dev_t r_ssif_Dev[R_SSIF_MACRO_NUM];
...
/*******************************************************************************
 ...
 Parameters:
  Unit          - Ssif Macro instance number
...
/*******************************************************************************
  ...
  Error      - Error code, see: <r_ssif_Error_t>
