...
FILE    : $Id: r_taub_main.h 2245 2014-04-01 09:51:36Z michael.golczewski $
============================================================================ 
DESCRIPTION
Generic TAUB driver
============================================================================
...
typedef struct {
    ...
    uint32_t   Settings;
    uint32_t   Config;
    void       (*IsrCallback[R_TAUB_INT_NUM])(void);
...
DEF_EXTERN_ r_taub_Dev_t r_taub_Dev[R_TAUB_MACRO_NUM];
...
/*******************************************************************************
 ...
 Parameters:
  Unit          - Taub Macro instance number
...
/*******************************************************************************
  ...
  Error      - Error code, see: <r_taub_Error_t>
