...
#ifndef RTW_HEADER_IVN_Decryption_private_h_
#define RTW_HEADER_IVN_Decryption_private_h_
...
#endif                                 /* RTW_HEADER_IVN_Decryption_private_h_ */
